  ...
  return (
    <div className="p-4 md:p-8 lg:p-10 w-full space-y-8 flex-1">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
          <p className="text-xs font-bold uppercase tracking-widest text-teal-700 mb-1 lg:mb-2 text-opacity-80">Institutional Analytics</p>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <button className="px-4 py-2 bg-teal-700 hover:bg-teal-800 text-white font-bold text-sm rounded-lg shadow-sm hover:shadow-md transition-all flex items-center gap-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-6">
        ...
        <div className="md:col-span-2 lg:col-span-2 bg-white rounded-[1.5rem] p-6 shadow-sm flex flex-col justify-between overflow-hidden relative group border border-slate-100">
          <div className="absolute -top-4 -right-4 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
            <div className="w-32 h-32 bg-teal-700 rounded-full blur-2xl"></div>
          </div>
          <div className="relative z-10 w-full mb-6">
            ...
            <div className="flex items-center gap-2 mt-2">
              <span className="px-2 py-0.5 bg-teal-100 text-teal-800 font-black text-xs rounded-full">+12.5%</span>
          ...
          <div className="mt-auto h-12 w-full flex items-end gap-1.5 relative z-10 opacity-80 group-hover:opacity-100 transition-opacity">
            <div className="flex-1 bg-teal-100 rounded-t-sm h-[30%]"></div>
            <div className="flex-1 bg-teal-200 rounded-t-sm h-[40%]"></div>
            <div className="flex-1 bg-teal-300 rounded-t-sm h-[50%]"></div>
            <div className="flex-1 bg-teal-400 rounded-t-sm h-[80%]"></div>
            <div className="flex-1 bg-teal-500 rounded-t-sm h-[60%]"></div>
            <div className="flex-1 bg-teal-600 rounded-t-sm h-[90%]"></div>
            <div className="flex-1 bg-teal-700 rounded-t-sm h-[75%]"></div>
            <div className="flex-1 bg-teal-800 rounded-t-sm h-[85%]"></div>
            <div className="flex-1 bg-teal-900 rounded-t-sm h-[100%] shadow-[0_0_10px_rgba(13,148,136,0.5)]"></div>
          </div>
        </div>
          ...
          <div className="mt-8 space-y-4 w-full">
            <div>
              <div className="flex justify-between text-xs mb-1 font-bold">
                <span className="text-teal-700">Elite Plan</span>
                <span className="text-slate-500">720 (56%)</span>
              </div>
              <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
                <div className="bg-teal-600 h-full rounded-full w-[56%]"></div>
              </div>
            </div>
            <div>
              <div className="flex justify-between text-xs mb-1 font-bold">
        ...
        {/* Active Exams Card */}
        <div className="md:col-span-1 lg:col-span-1 bg-teal-800 rounded-[1.5rem] p-6 shadow-md flex flex-col justify-between text-white border border-teal-700 relative overflow-hidden group">
          ...
          <p className="text-sm font-bold text-teal-200 uppercase tracking-wider relative z-10 w-full text-left">Active Exams</p>
          <div className="relative z-10 mt-auto">
            <h3 className="text-4xl font-black text-white mt-1 tracking-tight">42</h3>
            <div className="mt-3 text-[11px] font-bold text-teal-300 flex items-center gap-1.5 bg-teal-900/50 w-max px-2.5 py-1 rounded-full uppercase tracking-wider">
      ...
      <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-slate-100">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 gap-4">
          ...
          <div className="flex gap-2 p-1 bg-slate-100 rounded-xl">
            <button className="px-4 py-1.5 text-xs font-black bg-white text-teal-800 rounded-lg shadow-sm uppercase tracking-wider transition-colors">Revenue</button>
        ...
        <div className="w-full h-64 relative">
          <svg className="w-full h-full overflow-visible" preserveAspectRatio="none" viewBox="0 0 1000 200">
            ...
            {/* Stroke Path */}
            <path d="M0,180 Q100,160 200,170 T400,120 T600,140 T800,80 T1000,60" fill="none" stroke="#0d9488" strokeLinecap="round" strokeWidth="4"></path>
            ...
            {[
              ...
              <circle key={i} cx={pt.cx} cy={pt.cy} fill="white" r="6" stroke="#0d9488" strokeWidth="3.5" className="hover:r-[8px] cursor-crosshair transition-all"></circle>
            ))}
          </svg>
          ...
          <div className="flex justify-between mt-6 px-2 text-[10px] font-black text-slate-400 uppercase tracking-widest">
            ...
            <span>21 Oct</span>
            <span>28 Oct</span>
            <span className="text-teal-700 bg-teal-50 px-2 py-0.5 rounded">Current</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <a className="text-xs font-black uppercase text-teal-700 hover:text-teal-800 bg-teal-50 hover:bg-teal-100 px-4 py-2 rounded-lg transition-colors tracking-widest" href="#">View All Activity</a>
        </div>
                ...
                <tr key={idx} className="hover:bg-slate-50/50 transition-colors group">
                  <td className="px-6 py-5">
                    <div className="flex items-center gap-4">
                      <div className={`w-10 h-10 rounded-full flex items-center justify-center text-white font-black shadow-inner
                         ${tx.color === "teal" ? "bg-teal-700" : "bg-slate-600"}`}>
                        {tx.initial}
                      </div>
                      <div>
                        <p className="text-sm font-bold text-slate-900 group-hover:text-teal-700 transition-colors">{tx.name}</p>
                  ...
                  <td className="px-6 py-5">
                    <span className={`px-2.5 py-1 text-[10px] font-bold rounded uppercase tracking-widest
                      ${tx.color === "teal" ? "bg-teal-50 text-teal-700 border border-teal-100" : "bg-slate-100 text-slate-700 border border-slate-200"}
                    `}>
                      {tx.plan}
                    </span>
                  </td>
                  ...
                  <td className="px-6 py-5">
                    <div className="flex items-center justify-center gap-1.5 text-teal-600 font-bold text-[10px] bg-teal-50/50 py-1.5 rounded-lg border border-teal-100 uppercase tracking-widest w-full group-hover:bg-teal-50 transition-colors">
